        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Form ini mengirim data filter ke controller. -->
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="default-select form-control wide" name="status_pembayaran">
                                        ...
                                        <option value="Sudah Dibayar"
                                            {{ request('status_pembayaran') == 'Sudah Dibayar' ? 'selected' : '' }}>Sudah
                                            Dibayar</option>
                                        <option value="Belum Dibayar"
                                            {{ request('status_pembayaran') == 'Belum Dibayar' ? 'selected' : '' }}>Belum
                                            Dibayar</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <select class="default-select form-control wide" name="status_pengerjaan">
                                        ...
                                        <option value="Sudah Siap"
                                            {{ request('status_pengerjaan') == 'Sudah Siap' ? 'selected' : '' }}>Sudah Siap
                                        </option>
                                        <option value="Belum Siap"
                                            {{ request('status_pengerjaan') == 'Belum Siap' ? 'selected' : '' }}>Belum Siap
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <select class="default-select form-control wide" name="status_pengambilan">
                                        ...
                                        <option value="Sudah Diambil"
                                            {{ request('status_pengambilan') == 'Sudah Diambil' ? 'selected' : '' }}>Sudah
                                            Diambil</option>
                                        <option value="Belum Diambil"
                                            {{ request('status_pengambilan') == 'Belum Diambil' ? 'selected' : '' }}>Belum
                                            Diambil</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card bg-success text-white mb-0">
                                        <div class="card-body">
                                            ...
                                            <h3 class="text-white">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card bg-warning text-white mb-0">
                                        <div class="card-body">
                                            ...
                                            <h3 class="text-white">Rp {{ number_format($totalBelumBayar, 0, ',', '.') }}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse($data as $item)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($item->tanggal_transaksi)->format('d/m/Y H:i') }}
                                                </td>
                                                <td>{{ $item->nama_pelanggan }}</td>
                                                <td>{{ $item->no_telfon }}</td>
                                                <td><strong>Rp
                                                        {{ number_format($item->total_harga, 0, ',', '.') }}</strong></td>
                                                <td>
                                                    @if ($item->deleted_at)
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="10" class="text-center py-4">
                                                    ...
                                                    <p class="text-muted">Tidak ada data transaksi sesuai filter yang
                                                        dipilih</p>
                                                </td>
                                            </tr>
                                        @endforelse
