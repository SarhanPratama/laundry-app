                            ...
                            <table class="table table-striped table-bordered">
                                <thead class="table-ligt">
                                    <tr>
                                        ...
                                        <th style="width: 45%;"><strong>NAMA LAYANAN</strong></th>
                                            ...
                                            {{-- tombol edit --}}
                                                <div class="d-flex justify-content-center">
                                                    <a class="btn btn-success btn-sm" href="javascript:void(0)"
                                                        onclick="editData('{{ $value->id }}', '{{ $value->nama_layanan }}', '{{ $value->harga }}')"
                                                        title="Edit">
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('layanan.store') }}">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTambahLabel">Tambah Layanan Laundry</h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" id="formEdit">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditLabel">Edit Layanan Laundry</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span>&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Layanan</label>
                            <input type="text" class="form-control" name="nama_layanan" id="edit_nama_layanan" required>
                        </div>
                        <div class="form-group">
                            <label>Harga</label>
