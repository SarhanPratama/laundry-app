    <div class="modal fade" id="modalEdit{{ $value->id }}">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                //edit data layanan
                <form action="{{ url('admin/layanan', $value->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="satuan" class="form-control" required>
                                <option value="Kg" {{ (isset($value->satuan) && $value->satuan == 'Kg') ? 'selected' : '' }}>Kg (Kiloan)</option>
                                <option value="Pcs" {{ (isset($value->satuan) && $value->satuan == 'Pcs') ? 'selected' : '' }}>Pcs (Satuan)</option>
                            </select>
                        </div>
                        <div class="mb-3">
