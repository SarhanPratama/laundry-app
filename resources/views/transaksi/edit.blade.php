                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="default-select form-control wide" name="status_pembayaran"
                                        {{ $transaksi->status_pembayaran == 'Sudah Dibayar' ? 'disabled' : '' }}>
                                        ...
                                        <option value="DP"
                                            {{ $transaksi->status_pembayaran == 'DP' ? 'selected' : '' }}>
                                            DP (Sebagian)
                                        </option>
                                        ...
                                        <div class="row g-3 layanan-item mb-3 align-items-end p-3 border rounded bg-light">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select name="items[{{ $index }}][layanan_id]"
                                                    ...
                                                    @foreach ($layananList as $l)
                                                        <option value="{{ $l->id }}"
                                                            data-harga="{{ $l->harga }}" data-satuan="{{ $l->satuan ?? 'Kg' }}"
                                            ...
                                            <div class="col-md-1 text-nowrap">
                                                ...
                                                <input type="number" name="items[{{ $index }}][qty]"
                                                    ...
                                                    value="{{ $detail->qty }}" step="0.1" min="0.1"
                                                    required>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="number"
                                                        name="items[{{ $index }}][harga_kategori]"
                                                        class="form-control form-control-sm harga-kategori-input"
                                                        value="{{ $detail->harga_kategori }}" step="100"
                                                        min="0" required>
                                                    <button type="button" class="btn btn-secondary btn-sm btn-auto-harga"
                                    ...
                                    <div class="card border-0 bg-light shadow-sm">
                                        <div class="card-body">
                                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                                ...
                                                <input type="hidden" id="total-keseluruhan-raw"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <div class="col-md-1 text-nowrap">
                ...
                <input type="number" name="items[${newIndex}][qty]"
                    class="form-control form-control-sm qty-input"
        ...
        `;
            ...
            function initLayananItemEvents(item) {
                ...
                function calculateSubtotal() {
                    ...
                    const hargaKategori = parseFloat(hargaKategoriInput ? hargaKategoriInput.value : 0) || 0;
            ...
            function calculateAllTotals() {
                ...
                // Hitung ulang kembalian jika elemen pembayaran tersedia
            ...
            document.querySelectorAll('.layanan-item').forEach(item => {
                ...
                const hargaLayananInput = item.querySelector('.harga-layanan-input');
                const hargaKategoriInput = item.querySelector(
                    '.harga-kategori-input');
                const layananSelect = item.querySelector('.layanan-select');
                const packageSelect = item.querySelector('.package-select');
                ...
                if (selectedPackage && parseFloat(hargaKategoriInput.value) === parseFloat(selectedPackage
                        .dataset.harga || 0)) {
                    updateInputStyle(hargaKategoriInput, 'auto');
                } else {
                    updateInputStyle(hargaKategoriInput, 'manual');
                }
