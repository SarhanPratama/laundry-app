            ...
            <div class="col-lg-12">
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                                ...
                                <div class="status-item p-3 bg-light rounded">
                                    ...
                                    @elseif ($transaksi->status_pembayaran == 'DP')
                                        <span class="badge bg-warning fs-6 px-3 py-2 text-dark">
                                            <i class="fas fa-hand-holding-usd me-2"></i>DP (Sebagian)
                                        </span>
                                    @else
                        ...
                        <!-- Customer Info, Mengambil data dari hasil join query di controller -->
                        ...
                        <div class="items-section mb-4">
                                ...
                                <table class="table table-hover mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="10%" class="text-end">Jumlah/Berat</th>
                                            <th width="15%" class="text-end">Harga Layanan</th>
                                            <th width="15%" class="text-end">Harga Kategori</th>
                            ...
                            <!-- Summary Cards, rekap data -->
                            <div class="row mt-4">
                                <div class="col-md-4">
                                    <div class="card border-0 bg-light shadow-sm h-100">
                                        <div class="card-body text-center">
                                            <div class="text-muted small mb-2">
                                                <i class="fas fa-boxes me-2"></i>Total Item/Qty
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 bg-light shadow-sm h-100">
                                        <div class="card-body text-center">
                                            <div class="text-muted small mb-2">
                                                <i class="fas fa-box me-2"></i>Total Harga Kategori
                                            </div>
                            ...
                            <div class="mt-4">
                                <div class="card border-0 bg-primary text-white shadow-lg mb-4">
                                    ...
                                    <div class="card-footer bg-white text-dark d-flex justify-content-between py-3">
                                        <div class="fw-bold fs-5">Sudah Bayar: <span class="text-success">Rp
                                                {{ number_format($transaksi->bayar, 0, ',', '.') }}</span></div>
                                        <div class="fw-bold fs-5">
                                            @if ($transaksi->status_pembayaran == 'DP' || $transaksi->bayar < $transaksi->total_harga)
                                                Sisa/Kurang Bayar: <span class="text-danger">Rp
                                                    {{ number_format(abs($transaksi->total_harga - $transaksi->bayar), 0, ',', '.') }}</span>
                                            @else
                                                Kembalian: <span class="text-secondary">Rp
                                                    {{ number_format(max(0, $transaksi->bayar - $transaksi->total_harga), 0, ',', '.') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
