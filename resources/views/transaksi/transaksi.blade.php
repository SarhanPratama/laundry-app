...
@section('content')
                                    ...
                                    @foreach ($data as $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($value->status_pembayaran == 'DP')
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <a class="btn btn-info btn-sm me-1"
                                                        href="{{ route('transaksi.show', $value->id) }}" title="Lihat Detail">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-success btn-sm me-1"
                                                        href="{{ route('transaksi.edit', $value->id) }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                        data-url="{{ route('transaksi.destroy', $value->id) }}">
    ...
    <!-- memanngil blade Modal Tambah data -->
