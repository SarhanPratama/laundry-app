...
{{-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        // Update counters
        document.querySelector('.counter:contains("{{ number_format($totalPendapatanHariIni) }}")')
            .textContent = '{{ number_format($totalPendapatanHariIni) }}';
        document.querySelector('.counter:contains("{{ $totalTransaksiHariIni }}")').textContent =
            '{{ $totalTransaksiHariIni }}';
        document.querySelector('.counter:contains("{{ $totalPelanggan }}")').textContent =
            '{{ $totalPelanggan }}';
        document.querySelector('.counter:contains("{{ $cucianDalamProses }}")').textContent =
            '{{ $cucianDalamProses }}';
