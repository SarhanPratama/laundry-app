...
<div class="nav-header">
    ...
    <a href="{{ route('dashboard') }}" class="brand-logo d-flex align-items-center gap-2">
        ...
        <div class="brand-title">
            <h2 class="">Ghina.</h2>
            <span class="brand-sub-title">laundry</span>
        </div>
    </a>
...
<div class="header border-bottom">
    ...
    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
        ...
        <div class="d-flex align-items-center px-3 py-2 rounded-pill
            ...
            {{-- Icon User (sedikit lebih besar, tetap clean) --}}
            <i class="fas fa-user-circle fs-3 me-2 align-middle"></i>
