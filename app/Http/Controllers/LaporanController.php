...
class LaporanController extends Controller
{
    ...
    {
        //Ambil semua data pelanggan, urutkan berdasarkan nama.
        $pelangganList = DB::table('pelanggan')->orderBy('nama_pelanggan')->get();

        //kirim data pelanggan ke halaman laporan
    ...
    {
        //Ambil data transaksi, lalu gabungkan dengan data pelanggan.
        ...
        // Filter tanggal dari user yg memilih, maka tampilkan transaksi dari tgl tsb
        ...
        // Hitung statistik Menghitung jumlah transaksi
    ...
    public function harianPDF()
    {
        ...
        $data = DB::table('transaksi')
            ...
            //mengambil transaksi hanya hari ini
